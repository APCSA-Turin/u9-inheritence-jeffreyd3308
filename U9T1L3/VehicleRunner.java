...
public class VehicleRunner {
    public static void main(String[] args) {
        ...
        Car car2 = new Car("123456", 3, 4, false);
        Taxi taxi2 = new Taxi("234567", 3.5, 7, true, 4);
        System.out.println(car2.dropOffPassengers(2));
        System.out.println(car2.getPassengers());
        System.out.println(car2.dropOffPassengers(1));
        System.out.println(car2.getPassengers());
        System.out.println(taxi2.dropOffPassengers(6));
